...
const Topbar = () => {
  ...
  const { search_text, setSearch_text } = useContext(Context);
    ...
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex items-center gap-x-3">
        <input
          ...
          className="border px-4 py-1 rounded-lg border-gray-800 mr-1"
        />
        <input
          type="date"
          value={eDate}
          ...
          className="border px-4 py-1 rounded-lg border-gray-800 mr-1"
        />
        <button className="bg-aquaGreen flex items-center gap-x-3 text-white font-semibold px-5 py-2 text-lg rounded-lg">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
